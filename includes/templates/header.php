        ...
        <div class="items">
            <ul class="navbar-nav mr-auto">
                <li  class="nav-item p-2">
                    <a style="color:#fff;" class="nav-link" href="index.php">INICIO <span class="sr-only" style="color:red;">(current)</span></a>
                </li>
                <li class="nav-item p-2">
                    <a style="color:#fff;" class="nav-link" href="productos.php">PRODUCTOS</a>
                </li>
